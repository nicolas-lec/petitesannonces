...
Route::patch('update/{id}/',  'UserController@updateU')->name(('UpdateU'));

Route::get('update/show/{id}', 'UserController@showU')->name('showU');

Route::delete('update/delete/{id}', 'UserController@destroy')->name('destroyU');
